...
@Mod(
  modid = RelocationFMPMod.modID,
  useMetadata = true,
  modLanguage = "scala",
  acceptedMinecraftVersions = "[1.7.10]",
  dependencies = "required-after:ForgeRelocation;required-after:ForgeMultipart",
  name = RelocationFMPMod.modName,
  version = RelocationFMPMod.version
)
